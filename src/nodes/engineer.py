...
def code_engineer(state: SwarmState) -> dict:
    ...
    5. Wrap your code inside a single standard markdown code block: ```python ... ```
    6. Return ONLY valid, runnable Python code inside the block—no intro text or conversational commentary.
    """
